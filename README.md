...
Branch [dev-v3-cloudinary](https://github.com/Aditya-chamadia-09/Instagram-Mern/tree/dev-v3-cloudinary) uses Cloudinary to store images.

Branch [dev-v2-aws](https://github.com/Aditya-chamadia-09/Instagram-Mern/tree/dev-v2-aws) uses AWS S3 to store images.

Branch [dev-v1](https://github.com/Aditya-chamadia-09/Instagram-Mern/tree/dev-v1) uses local storage.
